...
from app.api.company_profiles import (CompanyProfileApi, CompanyProfileListApi,
                                      CompanyTypeApi, CompanyTypeListApi,
                                      CountriesListApi, EmployeeCountRangeApi,
                                      EmployeeCountRangeListApi, IndustryApi,
                                      IndustryListApi, ProvincesListApi,
...
def create_routes(api: Api):
    api.add_resource(
        CompanyProfileApi, "/api/company-profiles/<int:company_profile_id>"
    )  # noqa: E501
    ...
    api.add_resource(
        CompanyTypeApi, "/api/company-profiles/company-types/<string:company_type_name>"
    )  # noqa: E501
    api.add_resource(
        EmployeeCountRangeListApi, "/api/company-profiles/employee-count-ranges"
    )  # noqa: E501
    api.add_resource(
        EmployeeCountRangeApi,
        "/api/company-profiles/employee-count-ranges/<string:employee_count_range_name>",
    )  # noqa: E501
    api.add_resource(
        YearlyRevenueRangeListApi, "/api/company-profiles/yearly-revenue-ranges"
    )  # noqa: E501
    api.add_resource(
        YearlyRevenueRangeApi,
        "/api/company-profiles/yearly-revenue-ranges/<string:yearly_revenue_range_name>",
    )  # noqa: E501
    ...
    api.add_resource(
        IndustryApi, "/api/company-profiles/industries/<int:industry_id>"
    )  # noqa: E501
