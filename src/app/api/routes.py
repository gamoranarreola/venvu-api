...
def create_routes(api: Api):
    ...
    api.add_resource(CompanyTypeApi, "/api/company-profiles/company-types/<string:company_type_name>")
    api.add_resource(EmployeeCountRangeListApi, "/api/company-profiles/employee-count-ranges")
    api.add_resource(EmployeeCountRangeApi, "/api/company-profiles/employee-count-ranges/<string:employee_count_range_name>")
    api.add_resource(YearlyRevenueRangeListApi, "/api/company-profiles/yearly-revenue-ranges")
    api.add_resource(YearlyRevenueRangeApi, "/api/company-profiles/yearly-revenue-ranges/<string:yearly_revenue_range_name>")
