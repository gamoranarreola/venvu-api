...
Revision ID: 4c04048f13b2
Revises: 
Create Date: 2021-12-20 21:50:42.411368
...
def upgrade():
    ...
    sa.Column('key_products', sa.String(length=32), nullable=True),
    sa.Column('key_services', sa.String(length=32), nullable=True),
