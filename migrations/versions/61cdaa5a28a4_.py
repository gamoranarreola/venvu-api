...
Revision ID: 61cdaa5a28a4
Revises: 
Create Date: 2021-12-19 14:16:45.742830
...
def upgrade():
    ...
    sa.Column('type', sa.Enum('_CONSUMER', '_VENDOR', name='accounttype'), nullable=True),
